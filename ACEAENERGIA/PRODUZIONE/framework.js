...
styleRecordings.innerHTML = `
  ...
  .recordings-wrapper,.transfer-wrapper, .transferqueue-wrapper, .external-contacts-wrapper, .queue-report-wrapper {
    background: white;
    z-index: 99;
    display: flex;
  ...
  .recordings-wrapper,.transfer-wrapper, .transferqueue-wrapper{
		width: fit-content;
    height: 300px;
  }
...
function toggleTransfer(forceClose = false) {
    ...
    let wrapper = $('.transferqueue-wrapper');
    if (forceClose) {
        return wrapper.addClass('hidden');
    }
    wrapper.toggleClass('hidden');
...
<!--            </li>-->
    ...
    $('body').first().after(`
      ...
      <div class="transfer-wrapper hidden" id="draggableList5">
       ...
       <div class="transferqueue-wrapper hidden" id="draggableList6">
          <div class="header" id="draggableListHeader">
              <div class="list-header-recording">
                <h4 class="ml-8">Consulta</h4>
              <div onclick="toggleTransferQueue()" class="modal-header-btn modal-close">
                  <i class="fa fa-close fa-2x"></i>
                </div>
            </div>
          </div>
    ...
    dragElement(document.getElementById('draggableList6'));
        ...
        window.PureCloud.subscribe([{
            ...
            callback: function(category, interaction) {
                ...
                if (category === 'add' || category === 'change' ) 
                {
                   ...
                   //$('gef-record-control').prop('display','none');
